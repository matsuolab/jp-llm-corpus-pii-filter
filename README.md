...
大規模なデータセットに含まれる要配慮個人情報のすべてを目視で確認することは困難であるため，本フィルターは一定の配慮として適用することを想定しています. そのため，本コードにより全ての要配慮個人情報を排除できるものではない点について，あらかじめご了承ください.  

具体的には，CommonCrawlのようなテキストをtext属性として含むjsonl形式のデータに対し，要配慮個人情報を含むか否かを判定しフィルターします.  
